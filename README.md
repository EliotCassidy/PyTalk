...
> UPDATE : Ce projet a été récompensé du prix pour le meilleur projet NSI des premières de la région PACA (que vous pouvez voir [ici](https://trophees-nsi.fr/resultats))
